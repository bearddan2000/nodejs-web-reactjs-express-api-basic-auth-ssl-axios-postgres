...
function tear-down(){
    ...
    if [[ -d ./reactjs-srv/bin/node_modules ]]; then
      rm -Rf ./reactjs-srv/bin/node_modules
      rm -f ./reactjs-srv/bin/package-lock.json
    fi
    
    if [[ -d ./api/bin/node_modules ]]; then
      rm -Rf ./api/bin/node_modules
      rm -f ./api/bin/package-lock.json
    fi
